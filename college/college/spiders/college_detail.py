...
from college.items import CollegeDetailItem


class CollegeDetailSpider(scrapy.Spider):

    name = 'college_detail'
    # start_urls = ["http://www.liuxue.com/college/UniversityofNottingham/index/73-4.html"]
    ...
    def parse(self, response):
        ...
        profession = response.xpath('//div[@class="gre-major-table"]//span//text()').extract()
